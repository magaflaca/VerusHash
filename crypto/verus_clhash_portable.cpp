...
#include <x86intrin.h>
#elif defined(__arm__) || defined(__aarch64__) || defined(_M_ARM) || defined(_M_ARM64) || defined(_M_ARM) || defined(_M_ARM64)
